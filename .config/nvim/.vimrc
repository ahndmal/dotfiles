...
" https://github.com/selikapro/vimrc-likapro/blob/main/.vimrc
...
" Make <CR> aut-select the first completion item and notify coc.nvim to
...
"colorscheme vim-monokai-tastyo
